...
public class MenuDAOImpl implements MenuDAO {
	private static final String INSERT_QUERY = "INSERT INTO menu(restaurantId,itemName,description,price,isAvailable,category,image,createdAt,updatedAt,deletedAt) VALUES(?,?,?,?,?,?,?,?,?,?)";
	...
	private static final String UPDATE_QUERY = "UPDATE menu SET restaurantId=?, itemName=?, description=?, price=?, isAvailable=?, category=?, image=?, updatedAt=?, deletedAt=? WHERE menuId=?";
	...
	private static final String COUNT_QUERY = "SELECT COUNT(*) FROM menu";
	...
	private Menu getMenuByResultSet(ResultSet res) throws SQLException {
		...
		Menu m = new Menu(menuId, restaurantId, itemName, description, price, isAvailable, category, image, createdAt,
				updatedAt, deletedAt);
		return m;
	}
	@Override
