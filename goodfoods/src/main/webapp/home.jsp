...
<body>
				...
				<div class="profile">
					...
					<div class="dropdown">
						...
						<a href="profile.jsp">My Profile</a> <a href="MyOrdersServlet">My
							Orders</a> <a href="LogoutServlet">Logout</a>
	...
	<section class="hero">
		<div class="hero-content">
			...
			<p>Discover your favorite dishes from top restaurants and get
				them delivered quickly and safely.</p>
		...
		<div class="search-box">
			<form action="SearchServlet" method="get">
				<input type="text" name="keyword"
					placeholder="Search Food or Restaurant"> <input
	...
	<section>
		...
		<div class="review">
			⭐⭐⭐⭐⭐ <br> <br> Food arrived hot and fresh. Great service!
		</div>

		<div class="review">
			⭐⭐⭐⭐⭐ <br> <br> Easy ordering process and quick delivery.
		</div>

		<div class="review">
			⭐⭐⭐⭐⭐ <br> <br> Best food ordering experience I've had.
		</div>
	</section>
	...
	<footer>
		...
		<p>&copy; 2026 GoodFoods. All Rights Reserved.</p>
